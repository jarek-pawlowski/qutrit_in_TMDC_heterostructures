...
plot_bands.plot_energy_surface_k(subsets=basis_k.subspaces, energy=basis_k.basis_energies[0::2])
plot_bands.plot_spin_surface_k(subsets=basis_k.subspaces, spin=basis_k.basis_spins[0::2])
